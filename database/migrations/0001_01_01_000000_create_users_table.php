...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->varchar('nis',100)->nullable();
            $table->varchar('nisn',100)->nullable();
            $table->enum('grade',['1','2','3'])->nullable();
            $table->varchar('school_name',100)->nullable();
            $table->enum('school_category',['SMP','SMA'])->nullable();
            $table->varchar('domisili',100)->nullable();
            $table->integer('current_level');
            $table->varchar('avatar_url',100)->nullable();
