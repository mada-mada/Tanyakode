                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('courses.index') }}" class="nav-link">
                                ...
                                <p>Siswa <small class="badge badge-info">Soon</small></p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('courses.index') }}" class="nav-link">
                                ...
                                <p>Analitik <small class="badge badge-info">Soon</small></p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('courses.index') }}" class="nav-link">
                                ...
                                <p>Pengaturan <small class="badge badge-info">Soon</small></p>
                            </a>
                        </li>
