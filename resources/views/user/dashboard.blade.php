    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h1 class="fw-bold text-navy mb-2">
                Selamat Datang, <span
                    class="text-navy">{{ Auth::check() ? Auth::user()->full_name ?? Auth::user()->username : 'Guest' }}</span>
            </h1>
            ...
            <div class="navy-card delay-2">
                ...
                <div class="navy-card-body">
                    ...
                    <div id="joinForm" class="{{ Auth::user()->school_id ? 'd-none mt-4' : '' }}">
                        <p class="text-muted small mb-3">Masukkan <strong>Token Sekolah</strong> untuk terhubung dengan
                            instansi Anda.</p>
                        <form action="{{ route('user.join_school') }}" method="POST">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="token_code" class="form-control border-start-0 shadow-none"
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded-3 p-4 h-100 transition-card">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div>
                                                    <span
                                                        class="badge badge-navy mb-2 text-uppercase">{{ $course->level ?? 'Course' }}</span>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between mb-1">
                                                    ...
                                                    <small
                                                        class="fw-bold text-navy">{{ $enrollment->progress_percentage }}%</small>
                                                </div>
                                                <div class="progress-navy">
                                                    <div class="progress-bar-navy"
                                                        data-width="{{ $enrollment->progress_percentage }}"></div>
                                                </div>
                                            </div>
                                            <a href="{{ route('user.courses.show', $course->slug) }}"
                                                class="btn btn-navy w-100">Lanjutkan Belajar</a>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
