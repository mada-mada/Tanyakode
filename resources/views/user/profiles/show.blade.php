    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center mb-5">
            <div class="position-relative">
                <img src="{{ $user && $user->avatar_url ? asset('storage/' . $user->avatar_url) : 'https://ui-avatars.com/api/?name=' . urlencode($user->full_name ?? ($user->username ?? 'User')) . '&background=0a192f&color=64ffda' }}"
                    ...
                    <div class="navy-card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <p class="fw-bold text-navy">Kelas {{ $user->grade ?? '-' }}
                                    ({{ $user->school_category ?? '-' }})</p>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('user.join_school') }}" method="POST">
                                ...
                                <div class="input-group">
                                    <input type="text" name="token_code" class="form-control"
                                        placeholder="Contoh: SMAN1-ABC" required>
