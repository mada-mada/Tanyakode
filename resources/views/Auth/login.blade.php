...
<body class="bg-gray-50 h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-5xl h-[650px] md:h-[600px] rounded-2xl shadow-2xl overflow-hidden flex relative">
        ...
        <div
            ...
            @if (session('status'))
                <div
                    class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4 text-sm animate-fade-in">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            {{-- MODIFIKASI: Langsung Link ke Route Change Password --}}
                            <a href="{{ route('password.forgot') }}"
                                class="text-xs text-brand-blue hover:underline focus:outline-none">
                                Lupa Password?
                            </a>
                        </div>
                        <div class="relative">
