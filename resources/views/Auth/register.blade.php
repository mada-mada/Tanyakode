...
<body class="bg-blue-50 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="w-full max-w-4xl bg-white p-8 rounded-xl shadow-lg">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500">Lengkapi data diri dan sekolah Anda</p>
        </div>
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <h3 class="text-lg font-semibold text-blue-600 border-b pb-2 mb-4">Informasi Akun</h3>
                </div>
                ...
                <div class="md:col-span-2 mt-4">
                    <h3 class="text-lg font-semibold text-blue-600 border-b pb-2 mb-4">Data Pribadi & Sekolah</h3>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="nis" value="{{ old('nis') }}"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('nis') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <input type="number" name="nisn" value="{{ old('nisn') }}"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('nisn') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <input type="text" name="school_name" value="{{ old('school_name') }}"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('school_name') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    @error('school_category') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="block text-gray-700 font-medium mb-1">Kelas</label>
                    <select name="grade" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 bg-white @error('grade') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="domisili" value="{{ old('domisili') }}"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('domisili') border-red-500 @enderror" required>
