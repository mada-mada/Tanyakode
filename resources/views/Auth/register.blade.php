                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" autocomplete="off" placeholder="contoh@email.com" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:border-brand-blue outline-none transition @error('email') border-red-500 @enderror" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="login-pass" autocomplete="new-password" placeholder="••••••••" class="w-full pl-10 pr-10 py-3 rounded-lg border border-gray-300 focus:border-brand-blue outline-none transition @error('password') border-red-500 @enderror" required>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="username" value="{{ old('username') }}" autocomplete="off" placeholder="Username Anda" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:border-brand-blue outline-none transition @error('username') border-red-500 @enderror" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <i class="fas fa-lock absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="password" name="password" id="register-pass" autocomplete="new-password" placeholder="••••••••" class="w-full pl-10 pr-10 py-3 rounded-lg border border-gray-300 focus:border-brand-blue outline-none transition @error('password') border-red-500 @enderror" required>
