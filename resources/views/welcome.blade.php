...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('images/logoputih.jpg') }}" type="image/jpeg">
    <link rel="shortcut icon" href="{{ asset('images/logoputih.jpg') }}">
    <link rel="apple-touch-icon" href="{{ asset('images/logoputih.jpg') }}">
    ...
    <style>
        :root {
            ...
            * {
            ...
            .logo-img {
                height: 50px;
                /* Mengatur tinggi logo di menu atas */
                width: auto;
                /* Lebar menyesuaikan agar tidak gepeng */
                margin-right: 1px;
                /* Memberi jarak antara logo dan teks TanyaKode */
                object-fit: contain;
            }
            ...
            .footer-logo-img {
                height: 50px;
                /* Mengatur tinggi logo di footer (bawah) */
                width: auto;
                margin-right: 1px;
                object-fit: contain;
            }
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <p class="hero-subtitle">
                        Bergabung dengan ribuan pelajar Indonesia yang sudah memulai perjalanan koding mereka di
                        TanyaKode.
                ...
                <div class="story-section">
                    <div class="story-content">
                        ...
                        <div class="story-text highlight">
                            ...
                            Tempat di mana setiap pertanyaan tentang koding mendapatkan jawaban yang jelas dan
                            aplikatif."
                        </div>
                ...
                <div class="articles-grid">
                    <div class="article-card">
                        <div class="article-header">
                            ...
                            <a href="{{ route('articles.index') }}" target="_blank" rel="noopener"
                                class="read-more">
                                Baca Selengkapnya
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Ya, benar! Level Dasar di TanyaKode sepenuhnya gratis tanpa biaya apapun.
                                ...
                                Ini adalah komitmen kami untuk membuat pendidikan koding dapat diakses oleh semua
                                pelajar.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Untuk naik ke Level Menengah, kamu harus menyelesaikan semua materi dan latihan
                                ...
                                Sistem akan secara otomatis membuka akses ke Level Menengah setelah persyaratan
                                terpenuhi.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-content">
                <div class="footer-about">
                    <div class="footer-logo">
                        <img src="{{ asset('images/logoputih.jpg') }}" alt="Logo TanyaKode" class="footer-logo-img"
                ...
                <div class="footer-links-section">
                    ...
                    <ul class="footer-links">
                        <li><a href="#"><i class="fas fa-circle"
                                    style="color: #06d6a0; font-size: 0.7rem;"></i> Level Dasar (Gratis)</a></li>
                        <li><a href="#"><i class="fas fa-circle"
                                    style="color: #ffd166; font-size: 0.7rem;"></i> Level Menengah</a></li>
                        <li><a href="#"><i class="fas fa-circle"
                                    style="color: #ef476f; font-size: 0.7rem;"></i> Level Tinggi</a></li>
                    </ul>
                </div>
