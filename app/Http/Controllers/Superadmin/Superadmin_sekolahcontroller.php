...
class Superadmin_sekolahcontroller extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('superadmin.sekolah.index')->with('success', 'Sekolah berhasil ditambahkan');
  }
  ...
  public function update(Request $request, $id)
  {
    ...
    $request->validate([
      'npsn' => ['required', Rule::unique('schools', 'npsn')->ignore($school->id)],
      'name' => 'required|string|max:255',
      'phone' => 'required',
      'address' => 'required',
      'email' => 'nullable|email',
    ...
    return redirect()->route('superadmin.sekolah.index')->with('success', 'Data sekolah berhasil diupdate');
  }

  public function destroy($id)
  {
    School::findOrFail($id)->delete();
    return redirect()->route('superadmin.sekolah.index')->with('success', 'Sekolah berhasil dihapus');
  }
}
